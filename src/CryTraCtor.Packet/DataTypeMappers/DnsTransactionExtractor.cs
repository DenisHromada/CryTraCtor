...
{
    public Collection<DnsTransactionSummaryModel> DnsTransactions { get; } = [];
    ...
    public static Collection<DnsTransactionSummaryModel> MapDnsTrafficToTransactions(DnsTransactionTraffic dnsTraffic)
    {
